<main class="container mx-auto p-4 flex-grow flex flex-col justify-center items-center">
    ...
    <form method="post" action="index.php?page=register" class="w-full max-w-md flex flex-col items-center">
        <input type="text" name="username" placeholder="Username" required class="input input-bordered w-full max-w-xs mb-4">
        <input type="email" name="email" placeholder="Email" required class="input input-bordered w-full max-w-xs mb-4">
